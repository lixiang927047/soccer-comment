...
def process_and_save_videos(input_folder, meta_filepath, output_folder, num_examples):
    ...
    train_json_output_path = os.path.join(output_folder, 'soccernet_finetune_matchtime_video_train_official_1115.json')
    eval_json_output_path = os.path.join(output_folder, 'soccernet_finetune_matchtime_video_eval_official_1115.json')
    ...
    print(f'train: {len(train_json_data_list)};  test: {len(eval_json_data_list)}')
...
meta_filepath = None #'/data/codes/lixiang/Video-LLaVA-main/dataset/soccernet_json/transcriptions_matchtime_audio.npy'
num_examples = 1e10

process_and_save_videos(input_folder, meta_filepath, output_folder, num_examples)
