...
deepspeed /data/lx/Video-LLaVA-main/videollava/train/train_mem.py \
    --deepspeed /data/lx/Video-LLaVA-main/scripts/zero2.json \
    --lora_enable True \
    --lora_r 128 \
    --lora_alpha 256 \
    --mm_projector_lr 2e-5 \
    --bits 4 \
    --model_name_or_path /data/lx/Video-LLaVA-main/videollava/llava-v1.5-7b \
